...
})({"bR6n2":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
var _caisse = require("./src/classes/caisse");
var _listetransac = require("./src/classes/listetransac");
var _transaction = require("./src/classes/transaction");
...
let caisse = new _caisse.Caisses(10000, []);
form.addEventListener('submit', (e)=>{
    e.preventDefault();
    let laTransaction = new _transaction.Transaction(typeOp.value, montant.valueAsNumber, motif.value);
    caisse.addTransac(laTransaction);
    let liste1 = new _listetransac.listeTransac();
...
},{"./src/classes/caisse":"5gKGF","./src/classes/transaction":"80DnE","./src/classes/listetransac":"4CUfK"}],"5gKGF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Caisses", ()=>Caisses
);
class Caisses {
    constructor(solde, trsc){
        this.observer = [];
        this.solde = solde;
    ...
    subscribe(obs2) {
        this.observer.push(obs2);
        console.log('subscribe');
    }
    unsubscribe(obs1) {
        let index = this.observer.indexOf(obs1);
    ...
    addTransac(transac) {
        ...
        if (transac.getType() === 'debit') this.solde -= transac.getMontant();
        else this.solde += transac.getMontant();
    }
    notify() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2MYtN"}],"2MYtN":[function(require,module,exports) {
...
},{}],"80DnE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2MYtN"}],"4CUfK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "listeTransac", ()=>listeTransac
);
class listeTransac {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2MYtN"}]},["bR6n2","85GYl"], "85GYl", "parcelRequireb93f")
